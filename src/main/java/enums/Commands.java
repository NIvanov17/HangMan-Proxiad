...
public class Commands {
	public static final String GAME_STATUS_LOSS = "HAHAHA You lost! The word was %s";
	...
	public static final String SINGLE_PLAYER_MODE = "Single Player";
	public static final String MULTI_PLAYER_MODE = "Multiplayer";
	public static final int TOTAL_TRIES = 6;
}
